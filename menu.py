...
while True:
    ...
    if opc == 1: 
        ...
        if filaVazia(): print('Não há lientes na fila')
        else: print('Cliente atendido: ', remove())
    elif opc == 4: print('Tamanho atual da fila: ', tamanho(), enter)
    elif opc == 5:
        break
    else: print('Opção inválida', enter)
    if filaVazia(): print('Todos os clientes foram atendidos. ')
    else:
